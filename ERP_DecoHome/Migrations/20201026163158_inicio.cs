    ...
    public partial class inicio : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "a18be9c0-aa65-4af8-bd17-00bd9344e575", 0, "25d71815-1fe7-48e3-91b0-587e43f5739d", "Ventas", "admin@gmail.com", true, false, null, "Juan", "ADMIN@GMAIL.COM", "ADMIN@GMAIL.COM", "Admin100#", "AQAAAAEAACcQAAAAEPxhzKnUJ0LMP5wH1mj10TYhjgnyrVd0z8OLgoHzy12k0izhXjNCO9PuLGSo2c8taw==", null, false, "Jefe de ventas", "Administrador", 45000.00m, "fe6f14d0-ae6f-43c2-87ac-21e1dc786c40", "García", "Pérez", false, "admin@gmail.com" });
            ...
            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "Id", "Amount", "Category", "Cost", "Name", "UnitPvp", "UnitPvpIva" },
                values: new object[,]
                {
                    { 15, 100, "Mesas", 110m, "Mesa de cocina", 143m, 173.03m },
                    { 14, 3, "Mesas", 190m, "Mesa de despacho", 247m, 298.87m },
                    { 13, 40, "Mesas", 19m, "Mesa de jardín", 24.70m, 29.89m },
                    { 12, 100, "Estanterías", 25m, "Estantería con puertas", 32.50m, 39.32m },
                    { 11, 80, "Estanterías", 30m, "Estantería de pared", 39m, 47.19m },
                    { 10, 100, "Estanterías", 50m, "Estantería de cubos", 65m, 78.65m },
                    { 9, 75, "Sofás", 850m, "Sofá cama 3 plazas", 1105m, 1337.05m },
                    { 6, 6, "Armarios", 375m, "Combinación armario", 487.50m, 589.87m },
                    { 7, 50, "Sofás", 390m, "Sofá 2 plazas", 507m, 613.47m },
                    { 5, 35, "Armarios", 105m, "Armario abierto", 136.5m, 165.17m },
                    { 4, 100, "Armarios", 75m, "Armario con puertas correderas", 97.5m, 117.97m },
                    { 3, 100, "Camas", 45m, "Colchón espuma", 58.50m, 70.79m },
                    { 2, 9, "Camas", 85.00m, "Cama apilable", 110.50m, 133.71m },
                    { 1, 100, "Camas", 185.00m, "Cama nido", 240.50m, 291.00m },
                    { 8, 100, "Sofás", 790m, "Sofá 3 plazas", 1027m, 1242.67m }
                });
